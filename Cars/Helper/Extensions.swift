...
extension Date {
    struct Format {
            static let withYear = "dd MMMM yyyy, hh:mm a"
            static let withOutYear = "dd MMMM, "
    }
    ...
    func converToString(dateFormat : String) -> String {
...
extension Data {
 static func convertJsonToData(_ dic :[String : Any]) -> Data? {
        do {
